...
import { User, Car, Heart, Settings, LayoutDashboard, Bell, ShieldAlert, BarChart3 } from 'lucide-react';

export type IconName = 'User' | 'Car' | 'Heart' | 'Settings' | 'LayoutDashboard' | 'Bell' | 'ShieldAlert' | 'BarChart3';
  ...
  return (
    <nav className='flex gap-1 overflow-x-auto pb-1 scrollbar-hide -mb-px'>
      {navigation.map((item) => {
        ...
        const isSpecial = item.name === 'Admin' || item.external;
