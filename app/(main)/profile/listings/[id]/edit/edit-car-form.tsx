...
import { UpdateCarRequestDto } from '@/features/cars/cars.dto';
import { CarFuelTypeEnumSchema, CarTransmissionEnumSchema } from '@/features/cars/cars.enums';
import { TGetCarByIdResponse, TUpdateCarRequest } from '@/features/cars/cars.types';
import { useForm } from '@tanstack/react-form';
import { AlertCircle, Calendar, Car, DollarSign, DoorOpen, Users } from 'lucide-react';
...
export default function EditCarForm({ car }: EditCarFormProps) {
  ...
  const defaultValues: TUpdateCarRequest = {
    brand: car.brand,
    model: car.model,
    year: car.year,
  ...
  const form = useForm({
    ...
    defaultValues,
    validators: {
      onSubmit: UpdateCarRequestDto,
    },
    async onSubmit({ value }) {
      setError('');

      try {
        const result = await CarsApi.updateCar({ id: car.id }, value);
